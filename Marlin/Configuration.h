...
#define STRING_CONFIG_H_AUTHOR "(LatchyRed, LatchyRed Printer)" // Who made the changes.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 9.96
  #define DEFAULT_bedKi 0.69
  #define DEFAULT_bedKd 96.11
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 200, 200, 800, 768.3 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 1200, 1200, 100, 1500 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 23, 0, -1.24 }
...
#define Z_PROBE_FEEDRATE_SLOW (15*60)
...
#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_PIXELS 99       // Number of LEDs in the strip. (Longest strip when NEOPIXEL2_SEPARATE is disabled.)
